...
app.use(express.static(path.join(__dirname, './'))) // serving our contact form on all routes 
...
app.post('/sendemail', (req, res, next) => {
    ...
    */
    var transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: 'nodetest95@gmail.com', //replace with your email
            pass: 'nodeTest@123' //replace with your password
        }
    });
    ...
    */
    var mailOptions = {
        from: 'nodetest95@gmail.com', //replace with your email
        to: 'bahubaliyh23@gmail.com', //replace with your email
